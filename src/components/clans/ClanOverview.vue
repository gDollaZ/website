...
import { EClanRole, ClanStats, Clan } from "@/store/clan/types";
...
export default class ClanOverview extends Vue {
  ...
  get loggedInPlayerIsShaman(): boolean {
    return (
      this.playersClan.shamans.find((s) => s === this.verifiedBtag) != undefined ||
